...
garant: pavel.korizek
perex: >
  Uděláme z Karviné transparentní město. Občané musí mít k dispozici dostatek informací, aby mohli politiky a úředníky kontrolovat. Zapojíme občany do rozhodování o městě.
order: 1
---
...
<dl class="c-program-key-point-list">
    ...
    <dd>Lidé vědí nejlépe, co jejich okolí trápí. Proto budeme podporovat participativní složku v rozpočtu města, o jejímž rozdělení mezi konkrétní projekty rozhodnou sami občané. Budeme usilovat o to, aby tato složka postupně rostla.</dd>
    ...
    <dd>Chceme z Opavy udělat město, které naslouchá svým občanům nejen před volbami. U každého velkého rozhodnutí se proto budeme již od začátku ptát na váš názor. Vše budeme plánovat tak, abyste se skutečně mohli zúčastnit.</dd>
